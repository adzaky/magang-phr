...
const timelineVariants = cva("grid", {
  variants: {
    positions: {
      ...
      responsive: "[&>li]:grid-cols-[0_min-content_1fr] md:[&>li]:grid-cols-[1fr_min-content_1fr]",
    },
  },
  defaultVariants: {
    positions: "left",
...
const timelineDotVariants = cva(
  "col-start-2 col-end-3 row-start-1 row-end-1 flex size-6 items-center justify-center rounded-full border-2 border-current",
  {
    variants: {
      status: {
        default: "[&>*]:hidden",
...
const timelineContentVariants = cva("row-start-2 row-end-2 pb-8 text-muted-foreground w-full", {
  variants: {
    side: {
      right: "col-start-3 col-end-4 mr-auto text-left",
      left: "col-start-1 col-end-2 ml-auto text-right",
      responsive: "col-start-3 col-end-4 mr-auto text-left md:col-start-1 md:col-end-2 md:ml-auto",
    },
  },
  defaultVariants: {
    side: "right",
...
const timelineHeadingVariants = cva("row-start-1 row-end-1 line-clamp-1 w-full truncate", {
  variants: {
    side: {
      right: "col-start-3 col-end-4 mr-auto text-left",
      left: "col-start-1 col-end-2 ml-auto text-right",
